...
public class DBAdapter extends SQLiteOpenHelper {
	...
	// Database Name
	private static final String DATABASE_NAME = "MyDatabase6.1";
	...
	private static final String KEY_QUERY_USER= "username";
	private static final String KEY_QUERY_REGARDING = "regarding";
	private static final String KEY_QUERY_QUERY = "question";
	...
	private static final String KEY_EVENT_TIMING = "time";
	...
	private static final String KEY_HOMEWOKR_ID = "homework_id";
	private static final String KEY_DEPT_HOMEWORK = "department_homework";
	private static final String KEY_YEAR_HOMEWORK = "year_homework";
	private static final String KEY_SUB_HOMEWORK = "subject_homework";
	private static final String KEY_DATE_HOMEWORK = "date_homework";
	private static final String KEY_HOMEWORK = "homework_to_upload";
	...
	public void onCreate(SQLiteDatabase db) {
		...
		Log.d("queryFaculty",queryFaculty);
			...
			String queryQuery="CREATE TABLE "+ QUERY_TABLE +" (" +
					KEY_QUERY_ID + " INTEGER PRIMARY KEY AUTOINCREMENT, " +
					KEY_QUERY_USER + " TEXT, " +
					KEY_QUERY_REGARDING+ " TEXT, " +
					KEY_QUERY_QUERY + " TEXT " + ")";

			Log.d("queryQuery",queryQuery);

		String queryEvent="CREATE TABLE "+ EVENT_TABLE +" (" +
				KEY_EVENT_ID + " INTEGER PRIMARY KEY AUTOINCREMENT, " +
				KEY_EVENT_NAME + " TEXT, " +
				KEY_EVENT_DATE + " TEXT, " +
				KEY_EVENT_TIMING+ " TEXT, " +
        ...
        String queryHomework="CREATE TABLE "+ HOMEWORK_TABLE +" (" +
                KEY_HOMEWOKR_ID + " INTEGER PRIMARY KEY AUTOINCREMENT, " +
                KEY_DEPT_HOMEWORK + " TEXT, " +
                KEY_YEAR_HOMEWORK + " TEXT, " +
                KEY_SUB_HOMEWORK + " TEXT, " +
                KEY_DATE_HOMEWORK + " TEXT," +

                KEY_HOMEWORK + " TEXT " + ")";
        Log.d("queryHomework",queryHomework );
	...
	public void addQuery(QueryBean queryBean) {
		//SQLiteDatabase db = this.getWritableDatabase();
		SQLiteDatabase db=this.getWritableDatabase();
		String query = "INSERT INTO query_table (username,regarding,question) values ('"+
				queryBean.getQuery_user()+"', '"+
				queryBean.getQuery_regarding()+"', '"+
				queryBean.getQuery_query()+"')";
		Log.d("query", query);
		db.execSQL(query);
		db.close();
	}
	...
	public void addEvent(EventBean eventBean) {
		//SQLiteDatabase db = this.getWritableDatabase();
		SQLiteDatabase db=this.getWritableDatabase();
		String query = "INSERT INTO event_table (name,venue,date,time) values ('"+
				eventBean.getEvent_name()+"', '"+
				eventBean.getEvent_venues()+"', '"+
				eventBean.getEvent_date()+"', '"+
				eventBean.getEvent_Timing()+"')";
		Log.d("query", query);
		db.execSQL(query);
		db.close();
	}
	...
	public void addHomework(HomeworkBean homeworkBean) {
		...
		String query = "INSERT INTO homework_table (department_homework,subject_homework,year_homework,date_homework,homework_to_upload) values ('"+
				homeworkBean.getDepartment_homework()+"', '"+
				homeworkBean.getSubject_homework()+"','"+
				homeworkBean.getYear_Homework()+"', '"+
				homeworkBean.getDate()+"', '"+
				homeworkBean.getHomewrok()+"')";
		Log.d("query", query);
		db.execSQL(query);
		db.close();
	}
	...
	public ArrayList<QueryBean> getAllQuery()
	{
		...
		if(cursor.moveToFirst())
		{
			do{
				...
				queryBean.setQuery_id(Integer.parseInt(cursor.getString(0)));
				queryBean.setQuery_user(cursor.getString(1));
				queryBean.setQuery_regarding(cursor.getString(2));
				queryBean.setQuery_query(cursor.getString(3));
	...
	public ArrayList<EventBean> getAllEvent()
	{
		...
		if(cursor.moveToFirst())
		{
			do{
				...
				eventBean.setEvent_id(Integer.parseInt(cursor.getString(0)));
				eventBean.setEvent_date(cursor.getString(1));
				eventBean.setEvent_Timing(cursor.getString(2));
				eventBean.setEvent_venues(cursor.getString(3));
				eventBean.setEvent_name(cursor.getString(4));
...
public ArrayList<HomeworkBean> gethomework()
{
	...
	SQLiteDatabase db = this.getWritableDatabase();
	String query = "SELECT * FROM homework_table";
	Cursor cursor = db.rawQuery(query, null);
	...
	if(cursor.moveToFirst())
	{
		do{
	        ...
	        homeworkBean.setHomewrok_id(cursor.getInt(0));
			homeworkBean.setDepartment_homework(cursor.getString(1));
			homeworkBean.setYear_Homework(cursor.getString(2));
			homeworkBean.setSubject_homework(cursor.getString(3));
			homeworkBean.setDate(cursor.getString(4));
			homeworkBean.setHomewrok(cursor.getString(5));
...
//############################### homework #######################################
public HomeworkBean getHomeworkBySubject(int studentSub)
{
	HomeworkBean homeworkBean = new HomeworkBean();
	SQLiteDatabase db = this.getWritableDatabase();
	String query = "SELECT * FROM homework_table where subject_homework="+studentSub;
	Cursor cursor = db.rawQuery(query, null);
	...
	if(cursor.moveToFirst())
	{
		do{
			...
			//homeworkBean.setDepartment_homework(Integer.parseInt(cursor.getString(0)));
...
//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
	public void deleteHomework(int homeworkID) {
		...
		String query = "DELETE FROM homework_table WHERE homework_id="+homeworkID ;
	...
	public void deleteEvent(int eventID) {
		...
		String query = "DELETE FROM event_table WHERE event_id="+eventID ;
	...
	public void deleteQuery(int queryID) {
		...
		String query = "DELETE FROM query_table WHERE query_id="+queryID ;
